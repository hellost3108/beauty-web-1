...
const Terms = () => (
    ...
    >
        ...
        <section>
            <h2>3. Thông tin sản phẩm và giá cả</h2>
            <p>
        ...
        <section>
            ...
            <p>Khi đặt hàng, bạn cam kết rằng:</p>
            <ul>
