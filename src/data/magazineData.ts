export const magazinePosts = [
    {
        ...
        subtitle: "Một cái tên đang dần được nhắc đến nhiều hơn trong cộng đồng yêu mỹ phẩm Hàn",
        ...
        readTime: "3 phút đọc",
        content: `
            <p class="drop-cap">Trong hành trình tìm kiếm những thương hiệu làm đẹp chất lượng từ Hàn Quốc để mang đến cho khách hàng, BNBG là một trong những cái tên Melalogy đã chọn lựa và giới thiệu tới cộng đồng.</p>
    ...
    },
    {
        ...
        subtitle: "Thương hiệu skincare gắn liền với tinh thần chăm sóc da chuyên sâu kiểu Hàn",
    ...
    {
        id: 3,
        title: "TIAM – Thương Hiệu Vitamin C Được Cộng Đồng Làm Đẹp Yêu Thích",
        subtitle: "Cái tên quen thuộc với những ai tìm kiếm giải pháp làm sáng da",
        excerpt: "TIAM là thương hiệu Hàn Quốc được biết đến rộng rãi trong cộng đồng làm đẹp quốc tế, đặc biệt với các sản phẩm dòng vitamin C. Hiện đã có mặt tại Melalogy.",
        author: "Đội Ngũ Melalogy",
        role: "Ban Biên Tập",
        ...
        content: `
            ...
            <h3>Được Yêu Thích Vì Điều Gì</h3>
            <p>Sức hút của TIAM đến từ việc thương hiệu tập trung rõ ràng vào một nhóm sản phẩm cốt lõi, thay vì dàn trải, giúp khách hàng dễ dàng lựa chọn sản phẩm phù hợp với nhu cầu của mình.</p>

            <h3>Khám Phá Cùng Melalogy</h3>
            <p>Là một trong những thương hiệu được Melalogy phân phối, TIAM hứa hẹn là lựa chọn đáng cân nhắc cho những ai đang tìm kiếm giải pháp chăm sóc da đến từ Hàn Quốc.</p>
        `
    },
    {
        id: 4,
        title: "Angel Liquid – Bí Quyết Dưỡng Da Trong Suốt Kiểu Hàn",
        subtitle: "Cái tên gắn liền với xu hướng dưỡng da 'glass skin' đang được ưa chuộng",
        excerpt: "Angel Liquid là sản phẩm/thương hiệu quen thuộc với những tín đồ theo đuổi làn da căng bóng kiểu Hàn Quốc, nay có mặt trong danh mục của Melalogy.",
        author: "Đội Ngũ Melalogy",
        role: "Ban Biên Tập",
