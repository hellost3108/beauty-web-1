        ...
        <section className="bg-[#f5f0ec] px-4 py-20 md:px-6 md:py-28">
            <div className="max-w-[1440px] mx-auto">
                <div className="mb-14 grid items-end gap-6 md:grid-cols-2 md:mb-16">
                    <h2 data-reveal="left" className="font-display text-5xl text-[#111111] tracking-[-0.022em] md:text-6xl">
                        Vì Sao Chọn <span className="text-[#b31324]">Melalogy</span>
                    </h2>
                    ...
                    {usps.map((item, index) => (
                        ...
                        >
                            <div className="flex items-start justify-between">
                                ...
                                <div className="w-14 h-14 rounded-full border border-[#b31324]/25 bg-[#fff5f6] flex items-center justify-center transition-colors duration-300 group-hover:bg-[#b31324] group-hover:border-[#b31324]">
                                    <item.icon className="w-7 h-7 text-[#b31324] group-hover:text-white" strokeWidth={1.5} />
                                </div>
                            </div>
                            <div>
                                <h3 className="font-display text-2xl text-[#111111] mb-3 leading-tight group-hover:text-white">{item.title}</h3>
