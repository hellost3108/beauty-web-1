        ...
        <section className="bg-[#f5f0ec] px-4 py-20 md:px-6 md:py-28">
            <div className="max-w-[1440px] mx-auto">
                <div className="mb-14 grid items-end gap-6 md:grid-cols-2 md:mb-16">
                    <h2 className="font-display text-5xl md:text-7xl text-[#1a1a1a] leading-[0.95] tracking-[-0.05em]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                    {usps.map((item, index) => (
                        <div key={item.title} className="group min-h-[260px] rounded-[28px] border border-black/10 bg-white/70 p-7 flex flex-col justify-between transition-all duration-500 hover:-translate-y-2 hover:bg-[#181515] hover:text-white hover:shadow-2xl">
