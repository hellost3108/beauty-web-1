...
import { Star, ChevronDown, Minus, Plus, Share2, Heart, Facebook, Instagram, Twitter } from 'lucide-react';
...
const GlowSection = () => {
    ...
    const products = [
        { id: 101, image: "/assets/placeholder-400x500.png", name: 'Glow Skin', price: '1,199', oldPrice: '1,299' },
        { id: 102, image: "/assets/placeholder-400x500.png", name: 'Glow Skin', price: '1,199', oldPrice: '1,299' },
        { id: 103, image: "/assets/placeholder-400x500.png", name: 'Glow Skin', price: '1,199', oldPrice: '1,299' },
        { id: 104, image: "/assets/placeholder-400x500.png", name: 'Glow Skin', price: '1,199', oldPrice: '1,299' },
    ];

    const handleShare = (product: typeof products[0], e: React.MouseEvent) => {
        e.stopPropagation();
    ...
    return (
        <section className="relative py-24 overflow-hidden bg-white">
            ...
            <div className="relative z-10 w-full px-6 md:px-10 lg:px-24 xl:px-32">
                {/* Section Title */}
                <div className="text-center mb-16">
                    <h2 className="font-display text-3xl md:text-4xl leading-none tracking-tight">
                        <span className="text-[#1a1a1a]">The Glow </span>
                        <span className="text-[#f01a33]">Everyone Wants</span>
                    </h2>
                </div>

                <div className="grid grid-cols-1 xl:grid-cols-2 gap-12 items-stretch">
                    {/* Featured Large Card */}
                    <div className="relative w-full h-full min-h-[500px] xl:min-h-auto rounded-[32px] overflow-hidden group shadow-2xl flex flex-col">
                        <img
                        ...
                        <div className="absolute bottom-12 left-10 space-y-6">
                            <div className="space-y-2">
                                <h3 className="font-display text-[2.25rem] text-white leading-tight">
                                    Celebrate Your Glow
                                </h3>
                            ...
                            <Button asChild className="relative bg-[#f01a33] text-white px-8 py-4 text-sm font-medium rounded-[14px] h-auto overflow-hidden group/btn shadow-lg shadow-red-500/20 hover:shadow-xl transition-shadow duration-500">
                                <Link href="/collection">
                                    <span className="relative z-10 group-hover/btn:text-[#f01a33] transition-colors duration-700">Explore more</span>
