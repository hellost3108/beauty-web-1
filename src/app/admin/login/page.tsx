  ...
  return (
    <main className="grid min-h-screen bg-[#171414] text-white lg:grid-cols-[1.05fr_0.95fr]">
      <section className="relative hidden overflow-hidden lg:block">
        <img src="/assets/brand-banner-melanin.png" alt="Melalogy — The Science of Melanin" className="h-full w-full object-cover opacity-75" />
      ...
      <section className="flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-md">
          ...
          <p className="mt-3 text-sm leading-6 text-white/55">Quản lý sản phẩm, banner, trang chủ, Blog, Tạp chí và nội dung thương hiệu.</p>
