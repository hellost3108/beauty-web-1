  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#171414] px-6 py-12 text-white">
      <section className="w-full max-w-md rounded-[2rem] border border-white/10 bg-white/[0.04] p-7 shadow-2xl sm:p-10">
        ...
        <h1 className="mt-3 font-display text-4xl">Đặt mật khẩu mới</h1>
        <p className="mt-3 text-sm leading-6 text-white/55">Nhập mật khẩu riêng cho tài khoản quản trị. Không chia sẻ mật khẩu với bất kỳ ai.</p>
        <ResetPasswordForm />
      </section>
    </main>
  );
