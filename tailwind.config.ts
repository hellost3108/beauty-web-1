    ...
    extend: {
      colors: {
        ...
        blush: {
          ...
          medium: "hsl(var(--blush-medium))",
          warm: "hsl(var(--blush-warm))",
        },
        brand: {
      ...
      fontSize: {
        ...
        "hero-lg": ["4rem", { lineHeight: "1.15", letterSpacing: "-0.02em" }],
        section: ["2rem", { lineHeight: "1.3" }],
        brand: ["1.75rem", { lineHeight: "1.4" }],
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      boxShadow: {
        soft: "0 4px 20px -4px hsl(349 75% 58% / 0.1)",
        card: "0 8px 32px -8px hsl(0 0% 0% / 0.08)",
        elevated: "0 16px 48px -12px hsl(0 0% 0% / 0.12)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      animation: {
        ...
        "slide-up": "slide-up 800ms ease-out forwards",
        "line-extend": "line-extend 600ms ease-out forwards",
